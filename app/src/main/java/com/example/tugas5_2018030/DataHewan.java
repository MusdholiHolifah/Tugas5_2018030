...
public class DataHewan extends
        RecyclerView.Adapter<DataHewan.HewanViewHolder> {
    ...
    @NonNull
    @Override
    public DataHewan.HewanViewHolder
    ...
    public void onBindViewHolder(@NonNull
                                         DataHewan.HewanViewHolder holder, int position) {
    ...
    public class HewanViewHolder extends
